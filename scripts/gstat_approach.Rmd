...
#Display variogram of basic gls model, spatial gls model, and spatial gls model with nugget
plot(Variogram(park_gls, form= ~ Utm_E + Utm_N, maxDist=max_dist))
plot(Variogram(park_sp, form= ~ Utm_E + Utm_N, maxDist=max_dist))
plot(Variogram(park_sp_nug, form= ~ Utm_E + Utm_N, maxDist=64308.87))
